	...
	const renderButtonOpenModal = () => {
		return (
			<>
				<button
					onClick={openModal}
					className="relative w-full sm:hidden flex justify-end items-center text-neutral-600 dark:text-neutral-400"
				>
					<MagnifyingGlassIcon
				...
				<button
					onClick={openModal}
					className="relative flex max-sm:hidden w-full items-center rounded-full border border-neutral-200 px-4 py-2 pr-11 shadow-lg dark:border-neutral-6000"
				>
	...
	return (
		<div className="HeroSearchForm2Mobile">
			...
			<Transition appear show={showModal} as={Fragment}>
				<Dialog
					as="div"
					className="HeroSearchFormMobile__Dialog z-max relative overflow-auto"
					onClose={closeModal}
				>
